...
min_centre_distance = 200 # minimum distance between the centres of detected circles
resolution = 0.05 # resolution of parameters (centre, radius) relative to image resolution
